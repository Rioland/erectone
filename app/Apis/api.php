...
if (isset($_REQUEST['addcardbtn'])) {
         $_REQUEST['phone'];
    $response = DataBase::addcard(htmlentities($_REQUEST['cnumber']), htmlentities($_REQUEST['ccv']), htmlentities($_REQUEST['expdate']), 
    htmlentities($_REQUEST['add1']),htmlentities($_REQUEST['add2']),htmlentities($_REQUEST['phone']),htmlentities($_REQUEST['town']),htmlentities($_REQUEST['country']),
