...
if($_SERVER['REQUEST_METHOD']=="POST"){
    if(isset($_REQUEST['uname']) and  isset($_REQUEST['psw']) and !empty($_REQUEST['uname']) and !empty($_REQUEST['psw']) ){
      $username=htmlentities($_REQUEST['uname']);
         $passs=htmlentities($_REQUEST['psw']);
          Database::login($username,$passs);
          if(isset( $_SESSION['error']) and !empty( $_SESSION['error'])){
              echo("<script>alert('".$_SESSION['error']."')</script>");
          }
        
    }else{
        $_SESSION['error'] ="all field reqire";
        if(isset( $_SESSION['error']) and !empty( $_SESSION['error'])){
              echo("<script>alert('".$_SESSION['error']."')</script>");
          }
    }
...
<body>
    ...
    <div class="card">
        <img src="dist/img/avatar2.png" alt="John" style="width:100%">
        <h1>Welcome Back</h1>
        <p class="title">CEO & Founder, Erect-one</p>
        <p>Erect One Ltd.</p>
    ...
    <div id="id01" class="modal">
        ...
        <form class="modal-content animate" action="<?php echo $_SERVER['PHP_SELF'];  ?>" method="post">
            <div class="imgcontainer">
                ...
                <img src="dist/img/avatar3.png" alt="Avatar" class="avatar">
            </div>
